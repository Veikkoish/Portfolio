...
export const projects: Project[] = [
    ...
    overview: [
      {
        ...
        image: publicPath('Omniframe/overview.webp'),
        imagePosition: 'left',
      },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'Timing Belts', category: 'mechanical' },
      { name: 'Blender', category: 'mechanical' },
    ...
    overview: [
      {
        description: 'Built as a group project for a course at NYU. I was responsible for the hardware and mechanical design as well as assembly and the software integration.',
        image: publicPath('RoboChess/overview.webp'),
        imagePosition: 'left',
      },
    ],
  },
  {
    ...
    image: publicPath('Memory Player/cover.webp'),
    category: ['hardware', 'software', 'mechanical'],
    projectType: 'Personal Project',
    skills: [
      { name: 'Embedded Systems', category: 'hardware' },
    ...
    overview: [
      {
        description: 'I wanted to give my girlfriend a unique and lasting anniversary gift. I made this small device that displays mostly memories, but also inside jokes, quotes, song recommendations, etc. It updates automatically every day to match the day of the year.',
        image: publicPath('Memory Player/inhand.webp'),
        imagePosition: 'left',
      },
    ],
  },
  ...
  //       image: publicPath('Lampiron/overview.webp'),
  //       imagePosition: 'left',
  //     },
  //   ],
  // },
  ...
  {
    title: 'Verify',
    slug: createSlug('Verify'),
    description: "Chrome extension for fact-checking news articles.",
    image: publicPath('Verify/cover.webp'),
    category: ['software'],
    projectType: 'Academic Group Project',
    skills: [
      ...
      { name: 'Chrome Extensions', category: 'software' },
      { name: 'Express', category: 'software' },
      { name: 'Google Gemini API', category: 'software' },
      { name: 'Google Fact Check API', category: 'software' },
      { name: 'Server-Sent Events (SSE)', category: 'software' },
      { name: 'Tailwind CSS', category: 'software' },
      { name: 'Chrome Scripting API', category: 'software' },
    ...
    overview: [
      {
        ...
        image: publicPath('Verify/overview.webp'),
        imagePosition: 'left',
      },
    ],
  },
  ...
  //   image: publicPath('Sunwhisper/cover.webp'),
  //   category: ['software'],
  //   projectType: 'Personal Project',
  //   skills: [
  //     { name: 'Python', category: 'software' },
